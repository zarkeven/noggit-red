...
namespace Noggit::Application
{
  ...
  bool NoggitApplication::initalize(int argc, char* argv[], std::vector<bool> Parser)
  {
	 ...
	 //Locate application relative path
	  Log << "Noggit Yellow - " << STRPRODUCTVER << std::endl;
	  ...
	  {
		  // LogError << "Unable to find listfile! please reinstall Noggit Yellow, or download from wow.tools" << std::endl;
	  }
	  ...
	  {
		  LogError << "Unable to find database definitions! please reinstall Noggit Yellow, or download from wow.tools" << std::endl;
	  }
		else
		{
